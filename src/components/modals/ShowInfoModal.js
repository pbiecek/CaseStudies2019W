...
class ShowInfoModal extends Component {
  ...
  render() {
    return (
      this.state.data &&
      (<Layer animation='zoomIn' responsive onClickOutside={this.props.onClose} onEsc={this.props.onClose}>
        <Swipeable onSwipedLeft={this.props.onClose} onSwipedRight={this.props.onClose}>
          <Box className='modal-content' flex>
            <Grid rows={['1/3', 'full']}
              ...
              <Box gridArea='content'>
                ...
                <Anchor target="_blank" alignSelf='center' size='xlarge' href={this.state.data.imdburl} margin='10px'>See more
                  >>></Anchor>
              </Box>
            </Grid>
          </Box>
